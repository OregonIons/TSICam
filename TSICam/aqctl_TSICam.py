...
class Cam():
    """
    Class for providing simple functionality of TSI camera remotely.
    ...
    def acq_single(self):
        ...
        :rtype: numpy array
        """
        image = self.camera.acquire_and_get_single_image()
        return image

    def set_exposure(self, exp):
        """Sets the exposure in seconds.

        :param exp: New exposure time in seconds
        :exp type: float
        """
    ...
    def get_exposure(self):
        """Returns the current exposure in seconds.
